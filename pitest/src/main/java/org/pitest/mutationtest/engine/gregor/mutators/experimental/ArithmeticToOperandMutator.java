...
public class ArithmeticToOperandMutator {
    
    
    public enum ArithmeticToOperandMutator2 implements MethodMutatorFactory {
    ...
    public enum ArithmeticToOperandMutator1 implements MethodMutatorFactory {
